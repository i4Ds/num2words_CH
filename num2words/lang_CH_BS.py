...
class Num2Word_CH_BS(Num2Word_EU):
    ...
    def setup(self):
        self.ordinal_declension = pd.read_excel(os.path.join(_HELPER_DATA, "numbers_helper.xlsx"), sheet_name="Ordinal_deklination")[["Deklination","Genus","Kasus", "Basel_short"]]
